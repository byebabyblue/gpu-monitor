        ...
        return {
            ...
            "running_tasks": [
                {"pid": t["pid"], "user": t["user"],
                 "cpu_percent": t["cpu"], "mem_percent": t["mem"],
                 "command": t["cmd"][:100], "time": t["etime"]}
                for t in info.running_tasks
            ],
            "queued_tasks": [
                {"pid": t["pid"], "user": t["user"],
                 "cpu_percent": t["cpu"], "mem_percent": t["mem"],
                 "command": t["cmd"][:100], "time": t["etime"]}
                for t in info.queued_tasks
            ],
...
def main():
    ...
    win = Dashboard(args.config, demo=args.demo)
    win.show()
